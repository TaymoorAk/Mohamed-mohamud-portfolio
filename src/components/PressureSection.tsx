      ...
      <div className="container mx-auto px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-6 order-1 lg:order-2">
            <h2 className="text-3xl lg:text-4xl xl:text-5xl font-bold leading-tight text-text-primary">
            ...
            <div className="space-y-4 pt-4">
              <p className="text-lg text-text-secondary leading-relaxed">
                Business as usual just won't cut it anymore, and you feel called to 
                lead change. <span className="font-semibold text-text-primary">Good news: effective change leadership in trying 
                times is not only possible but within your reach!</span>
              </p>
